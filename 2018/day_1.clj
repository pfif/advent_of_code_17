...
(println (resulting_frequency (parse_drifts (slurp "day_1_input")))) ;; First problem
...
(println (find_duplicate_frequency #{0} 0 (cycle (parse_drifts (slurp "day_1_input"))))) ;; Second problem
